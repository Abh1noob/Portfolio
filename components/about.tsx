...
export default function About() {
  return (
    <section className="scroll-mt-100 w-[100vw] h-[100vh]" id="home">
        <div className="text-[#B4F5F5] absolute top-[15rem] left-[5rem]">
          ...
          >
            I'm a student studying Computer Science at VIT Vellore, interested
            in making <br />
            and learning cool stuff in field of Computers and Microprocessors
            like Arduino <br />
            <br />
            I thrive on challenges, constantly seeking opportunities to expand
            my horizons. <br />
